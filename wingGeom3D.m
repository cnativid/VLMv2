function [wingGeomX,wingGeomY,wingGeomZ,panelRX,panelRY,panelRZ,panelTX,panelTY,panelTZ,panelCPX,panelCPY,panelCPZ,nX,nY,nZ,S,AR] = wingGeom3D(data,cPanels,cfun,alpha)
...
% cfun = MCL function
    ...
    [wingGeomX,wingGeomY,wingGeomZ] = eulerangles(wingGeomX,wingGeomY,wingGeomZ,0,alpha,0);
    b = 2*sum(sectionb);
    S = sectionb'*(sectionc(1:end-1)+sectionc(2:end))
    MAC = S/b;
    AR = b^2/S
